...
# dots = (np.random.rand(DOT_NUM, 2) - 0.5) * 0.1 + MIDDLE
...
plt.savefig('final1.pdf', bbox_inches='tight')
plt.savefig('final1.png', bbox_inches='tight')
# for i in range(10):
#         plt.scatter(i / 20 + 0.1, 0.3, c=[[1, 1 - i / 15, 0]])
#         plt.scatter(i / 20 + 0.1, 0.2, c=[[0.9 - i / 20, 0.2, 0.2]])
#         plt.scatter(i / 20 + 0.1, 0.1, c=[[0.2, 0.9 - i / 20, 0.2]])
